 ...
 */
abstract class DatasetTestBase extends BrowserTestBase {
   ...
   * @var array
   */
  public static $modules = ['node', 'datetime', 'dkan_dataset'];
  ...
  protected function setUp() {
    ...
    if ($this->profile != 'standard') {
      ...
      $this->drupalCreateContentType(['type' => 'dataset', 'name' => 'Dataset']);
    }
